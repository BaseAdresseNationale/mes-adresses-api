...
export class Start1721638331361 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "positions" ADD CONSTRAINT "FK_f44f6b9d8ccb2717953b8a3f2dd" FOREIGN KEY ("bal_id") REFERENCES "bases_locales"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "positions" DROP CONSTRAINT "FK_f44f6b9d8ccb2717953b8a3f2dd"`,
    );
    await queryRunner.query(
