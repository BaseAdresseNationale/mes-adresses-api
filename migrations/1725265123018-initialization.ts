...
export class Initialization1725265123018 implements MigrationInterface {
    name = 'Initialization1725265123018'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "positions" ("id" character varying(24) NOT NULL, "toponyme_id" character varying(24), "numero_id" character varying(24), "type" "public"."positions_type_enum" NOT NULL DEFAULT 'entrée', "source" text, "rank" integer NOT NULL, "point" geometry(Point,4326) NOT NULL, CONSTRAINT "PK_17e4e62ccd5749b289ae3fae6f3" PRIMARY KEY ("id"))`);
