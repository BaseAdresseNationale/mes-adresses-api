...
export class Start1721049240404 implements MigrationInterface {
    name = 'Start1721049240404'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "positions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "bal_id" uuid NOT NULL, "toponyme_id" uuid, "numero_id" uuid, "type" "public"."positions_type_enum" NOT NULL DEFAULT 'entrée', "source" text, "point" geometry(Point) NOT NULL, CONSTRAINT "PK_17e4e62ccd5749b289ae3fae6f3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "toponymes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "bal_id" uuid NOT NULL, "nom" text NOT NULL, "nom_alt" json, "parcelles" text array, CONSTRAINT "PK_f8e0f31344c7c2543562a61c1f1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "numeros" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "bal_id" uuid NOT NULL, "voie_id" uuid NOT NULL, "toponyme_id" uuid, "numero" text NOT NULL, "suffixe" text, "comment" text, "parcelles" text array, "certifie" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_afc7d4916c4ae1472683de49489" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."voies_type_numerotation_enum" AS ENUM('numerique', 'metrique')`);
        await queryRunner.query(`CREATE TABLE "voies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "bal_id" uuid NOT NULL, "nom" text NOT NULL, "nom_alt" json, "type_numerotation" "public"."voies_type_numerotation_enum" NOT NULL DEFAULT 'numerique', "centroid" geometry(Point), "trace" geometry(LineString), CONSTRAINT "PK_80c425cf773e2b81a56ba55a08c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."bases_locales_status_enum" AS ENUM('draft', 'published', 'demo', 'replaced')`);
        await queryRunner.query(`CREATE TABLE "bases_locales" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nom" text NOT NULL, "commune" character varying(5) NOT NULL, "emails" text array NOT NULL, "token" character varying(20) NOT NULL, "status" "public"."bases_locales_status_enum" NOT NULL, "habilitation_id" character varying(24), "sync" jsonb, CONSTRAINT "PK_9ebcac4bb5518b2d3e0894cb5c4" PRIMARY KEY ("id"))`);
