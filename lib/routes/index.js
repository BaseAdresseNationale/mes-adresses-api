...
app.route('/bases-locales/:baseLocaleId/numeros/batch')
  .put(ensureIsAdmin, w(async (req, res) => {
    const modifiedCount = await Numero.batchUpdateNumeros(req.baseLocale._id, req.body)
...
app.route('/bases-locales/:baseLocaleId/communes/:codeCommune/batch')
  .put(ensureIsAdmin, w(async (req, res) => {
    const modifiedCount = await BaseLocale.batchUpdateNumeros(req.baseLocale._id, req.params.codeCommune, req.body)
    res.send(modifiedCount)
  }))
...
app.route('/voies/:voieId/batch')
  .put(ensureIsAdmin, w(async (req, res) => {
    const modifiedCount = await Voie.batchUpdateNumeros(req.voie._id, req.body)
    res.send(modifiedCount)
  }))
