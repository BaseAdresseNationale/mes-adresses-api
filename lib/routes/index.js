...
app.route('/bases-locales/:baseLocaleId/numeros/batch')
  .put(ensureIsAdmin, w(async (req, res) => {
    await Numero.updateNumerosByBatch(req.baseLocale._id, req.body)
    res.sendStatus(200)
  }))
...
app.route('/bases-locales/:baseLocaleId/communes/:codeCommune/batch')
  .put(ensureIsAdmin, w(async (req, res) => {
    await BaseLocale.updateNumerosByBatch(req.baseLocale._id, req.params.codeCommune, req.body)
    res.sendStatus(200)
  }))
...
app.route('/voies/:voieId/batch')
  .put(ensureIsAdmin, w(async (req, res) => {
    await Voie.updateNumerosByBatch(req.voie._id, req.body)
    res.sendStatus(200)
  }))
