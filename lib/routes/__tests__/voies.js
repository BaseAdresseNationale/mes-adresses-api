...
const KEYS = ['_id', '_bal', 'commune', 'nom', 'code', '_created', '_updated', 'nomAlt', 'typeNumerotation', 'trace']
...
test.serial('create a voie / with unsupported nomAlt', async t => {
  ...
  t.deepEqual(body, {
    ...
    validation: {
      nomAlt: ['"nomAlt" failed custom validation because Valeurs "nomAlt" inattendues : gua et bri. Valeurs attendues : fra, bre, eus, gsw, cos, gcr, gcf, rcf, swb,cat ou oci']
    }
  })
})
