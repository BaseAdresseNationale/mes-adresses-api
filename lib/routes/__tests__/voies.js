...
const KEYS = ['_id', '_bal', 'commune', 'nom', 'code', '_created', '_updated', 'nomAlt', 'typeNumerotation', 'trace', 'nbNumeros', 'nbNumerosCertifies', 'isAllCertified']
...
test('Count numeros & certified numeros', async t => {
  ...
  await mongo.db.collection('numeros').insertOne({_bal: _id, voie: _id, numero: 1, certifie: true})
  await mongo.db.collection('numeros').insertOne({_bal: _id, voie: _id, numero: 2, certifie: true})
