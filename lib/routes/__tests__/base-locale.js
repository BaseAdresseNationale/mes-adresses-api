...
const KEYS = ['nom', 'emails', 'token', 'commune', 'nbNumeros', 'nbNumerosCertifies', 'isAllCertified', '_updated', '_created', '_deleted', '_id', 'status']
const SAFE_FIELDS = ['nom', 'commune', '_updated', 'nbNumeros', 'nbNumerosCertifies', 'isAllCertified', '_created', '_deleted', '_id']
