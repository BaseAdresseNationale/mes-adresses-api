...
const KEYS = ['nom', 'emails', 'token', 'commune', 'nbNumeros', 'nbNumerosCertifies', '_updated', '_created', '_id', 'status']
const SAFE_FIELDS = ['nom', 'commune', '_updated', 'nbNumeros', 'nbNumerosCertifies', '_created', '_id']
