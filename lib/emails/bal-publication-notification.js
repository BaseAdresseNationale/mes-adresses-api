...
const bodyTemplate = template(`
  ...
  <body>
    <div class="banner">
      <img src="../../static/images/logo-marianne.svg" alt="Logo République Française">
    ...
    <div class="container">
      <p>Les adresses de votre commune sont maintenant à jour et viennent alimenter les référenciels nationaux.</p>
      <p>Il est désormais plus simple pour vos administrés d'être:</p>
      <ul>
        <li>Déclarés auprès des fournisseurs d'eau et d'énergies</li>
        <li>Éligible à la fibre</li>
        <li>Livrés</li>
