...
const {getTasksCache, setTasksCache} = require('../tasks/tasks-cache')
...
async function detectConflict() {
  ...
  const detectConflictPublishedSince = await getTasksCache('detectConflictPublishedSince')
  ...
  await setTasksCache('detectConflictPublishedSince', futurePublishedSince)
