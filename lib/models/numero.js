...
async function create(idVoie, payload) {
  ...
  if (numero.toponyme) {
    const toponyme = await mongo.db.collection('toponymes').findOne({_id: numero.toponyme})
...
async function update(id, payload) {
  ...
  if (numeroChanges.toponyme) {
    const toponyme = await mongo.db.collection('toponymes').findOne({_id: numeroChanges.toponyme})
