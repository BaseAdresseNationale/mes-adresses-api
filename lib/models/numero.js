...
async function create(idVoie, payload) {
  ...
  await mongo.touchDocument('bases_locales', numero._bal, numero._created)
  await mongo.touchDocument('voies', numero.voie, numero._created)
...
async function update(id, payload) {
  ...
  await mongo.touchDocument('voies', value.voie, value._updated)
...
async function remove(id) {
  ...
  if (value) {
    ...
    await mongo.touchDocument('voies', value.voie, now)
  }
}
