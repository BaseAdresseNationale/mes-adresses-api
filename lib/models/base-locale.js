...
async function computeStats() {
  ...
  const publishedBasesLocalesIds = response.body.map(b => b.url.slice(54, 78))
  ...
  function getStatus(communeResult) {
    if (communeResult.basesLocalesIds.some(id => publishedBasesLocalesIds.includes(id.toString()))) {
      return 'published'
    }
