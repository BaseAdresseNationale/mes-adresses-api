...
const {voiesToPointGeoJSON, voiesToLineGeoJSON, numerosToGeoJSON} = require('../export/geojson')
...
async function getGeoJSON(id) {
  ...
  const pointVoies = voiesToPointGeoJSON(voies, numeros)
  const lineVoies = voiesToLineGeoJSON(voies)
  const pointNumeros = numerosToGeoJSON(voies, toponymes, numeros)
  return {
    pointVoies,
    lineVoies,
    pointNumeros
