...
const createSchema = Joi.object().keys({
  ...
  commune: Joi.string()
    ...
    .required()
    .messages({'any.required': '"commune" is required', 'any.only': 'Code commune inconnu'})
})
...
async function cleanCommune(id, codeCommune) {
  ...
  if (baseLocale.commune !== codeCommune) {
...
async function getNumerosCount(idBal, codeCommune) {
