...
test('create a Toponyme / with unsupported nomAlt', async t => {
  ...
  t.deepEqual(error.validation, {
    nomAlt: ['"nomAlt" failed custom validation because Valeurs "nomAlt" inattendues : gua et gyn. Valeurs attendues : fra, bre, eus, gsw, cos, gcr, gcf, rcf, swb,cat ou oci']
  })
})
...
test('update a Toponyme / with unsupported nomAlt', async t => {
  ...
  t.deepEqual(error.validation, {
    nomAlt: ['"nomAlt" failed custom validation because Valeurs "nomAlt" inattendues : gua. Valeurs attendues : fra, bre, eus, gsw, cos, gcr, gcf, rcf, swb,cat ou oci']
  })
})
