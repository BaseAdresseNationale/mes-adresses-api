...
test('create a Toponyme', async t => {
  ...
  const keys = ['_id', '_bal', 'nom', 'positions', 'parcelles', 'commune', '_created', '_updated', '_deleted']
...
test('importMany', async t => {
  ...
  t.deepEqual(
    pick(v1, 'nom', 'commune', 'positions', 'parcelles', '_updated', '_created', '_deleted'),
    pick(toponyme1, 'nom', 'commune', 'positions', 'parcelles', '_updated', '_created', '_deleted')
  )
