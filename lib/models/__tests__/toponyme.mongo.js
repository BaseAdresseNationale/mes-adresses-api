...
test('create a Toponyme / with unsupported nomAlt', async t => {
  ...
  t.deepEqual(error.validation, {
    nomAlt: ['"nomAlt" failed custom validation because Valeurs "nomAlt" inattendues : gua et gyn. Valeurs attendues : fra, bre, eus, gsw, cos, gcr, gcf, rcf, swb, oci ou cat']
  })
})
...
test('update a Toponyme', async t => {
  ...
  t.deepEqual(toponyme.nomAlt, {gcf: 'Lapwent'})
...
test('update a Toponyme / with unsupported nomAlt', async t => {
  ...
  const error = await t.throwsAsync(() => Toponyme.update(_id, {
    nomAlt: {
      gua: 'Lapwent',
      gcf: 'Lapwent'
    }
  ...
  t.deepEqual(error.validation, {
    nomAlt: ['"nomAlt" failed custom validation because Valeurs "nomAlt" inattendues : gua. Valeurs attendues : fra, bre, eus, gsw, cos, gcr, gcf, rcf, swb, oci ou cat']
  })
})
