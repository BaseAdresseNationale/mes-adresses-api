...
test('create a Toponyme / with unsupported nomAlt', async t => {
  ...
  t.deepEqual(error.validation, {
    nomAlt: ['"nomAlt" failed custom validation because Valeurs "nomAlt" inattendues : gua et gyn.\nValeurs attendues : fra, bre, eus, gsw, cos, gcr, gcf, rcf, swb ou oci']
  })
})
...
test('update a Toponyme / with unsupported nomAlt', async t => {
  ...
  t.deepEqual(error.validation, {
    nomAlt: ['"nomAlt" failed custom validation because Valeurs "nomAlt" inattendues : gua.\nValeurs attendues : fra, bre, eus, gsw, cos, gcr, gcf, rcf, swb ou oci']
  })
})
