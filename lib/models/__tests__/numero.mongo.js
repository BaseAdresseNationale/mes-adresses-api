...
test('create a numero', async t => {
  ...
  const keys = ['_id', '_bal', 'commune', '_updated', '_created', '_deleted', 'voie', 'numero', 'suffixe', 'comment', 'toponyme', 'positions', 'parcelles', 'certifie']
...
test('create a numero / minimal', async t => {
  ...
  const keys = ['_id', '_bal', 'commune', '_updated', '_created', '_deleted', 'voie', 'numero', 'suffixe', 'positions', 'comment', 'toponyme', 'parcelles', 'certifie']
  t.true(keys.every(k => k in numero))
  t.is(Object.keys(numero).length, keys.length)
})
