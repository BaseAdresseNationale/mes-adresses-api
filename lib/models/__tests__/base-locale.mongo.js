...
test('Check if published BAL already published', async t => {
  ...
  t.is(alreadyPublishedBaseLocale.emails, undefined)
  t.is(alreadyPublishedBaseLocale.token, undefined)
  t.is(alreadyPublishedBaseLocale.status, 'published')
  t.true(alreadyPublishedBaseLocale.communes.includes('55326'))
  t.true(alreadyPublishedBaseLocale.isOwner)
})
