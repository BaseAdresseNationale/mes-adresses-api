...
test('Check if published BAL already published', async t => {
  ...
  const alreadyPublishedBaseLocale = await BaseLocale.checkPublishedBAL(['55326'], 'living@data.com')
  const alreadyPublishedBaseLocaleNotOwned = await BaseLocale.checkPublishedBAL(['55326'], 'fetching@data.com')
  const unpublishedBaseLocale = await BaseLocale.checkPublishedBAL(['55327'])

  t.is(alreadyPublishedBaseLocale[0].emails, undefined)
  t.is(alreadyPublishedBaseLocale[0].token, undefined)
  t.is(alreadyPublishedBaseLocale[0].status, 'published')
  t.true(alreadyPublishedBaseLocale[0].communes.includes('55326'))
  t.true(alreadyPublishedBaseLocaleNotOwned[0].communes.includes('55326'))
  t.true(alreadyPublishedBaseLocale[0].isOwner)
  t.is(alreadyPublishedBaseLocaleNotOwned[0].isOwner, false)
  t.deepEqual(unpublishedBaseLocale, [])
})
