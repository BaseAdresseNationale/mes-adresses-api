...
async function create(idBal, payload) {
  ...
  toponyme.nomAlt = toponyme.nomAlt && Object.keys(toponyme.nomAlt).length > 0 ? toponyme.nomAlt : null
...
async function update(id, payload) {
  ...
  if (toponymeChanges.nomAlt) {
    toponymeChanges.nomAlt = Object.keys(toponymeChanges.nomAlt).length > 0 ? toponymeChanges.nomAlt : null
  }
...
async function importMany(idBal, rawToponymes, options = {}) {
  ...
  const toponymes = rawToponymes
    .map(t => {
      ...
      toponyme.nomAlt = t.nomAlt && Object.keys(t.nomAlt).length > 0 ? t.nomAlt : null
