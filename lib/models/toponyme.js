...
const {checkTextAlreadyExistInNomVoieOrNomToponyme} = require('./nom')
...
async function create(idBal, payload) {
  ...
  await checkTextAlreadyExistInNomVoieOrNomToponyme(payload.nom, idBal)
...
async function update(id, payload) {
  ...
  const toponyme = await mongo.db.collection('toponymes').findOne({_id: mongo.parseObjectID(id)})
  console.log(toponyme)
  await checkTextAlreadyExistInNomVoieOrNomToponyme(payload.nom, toponyme._bal)
