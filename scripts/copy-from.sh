...
psql -d api-bal -U api-bal-user -c "\\COPY positions (id,numero_id,toponyme_id,type,source,point,rank) FROM '../export-csv/csv/mes-adresses-api/positions.csv' DELIMITER ',' CSV HEADER"
